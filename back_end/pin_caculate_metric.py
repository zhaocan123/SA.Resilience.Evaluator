...
def mmd1g_cd(require_document_list, use_case_document_list):
    Ai = mmd1g_cd_Ai(require_document_list, use_case_document_list)
    Bi = mmd1g_cd_Bi(require_document_list, use_case_document_list)
    n = len(Ai)
...
def get_rate(idlist, pass_dict):
    ...
    for i in idlist:
        ...
        if pass_dict[i][0]:
            strA = strA + i + ';'
    res = round(A/B,2) if B else 0
    return res,A,B,strA,strB
def fcl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
    ...
    try:
        res,A,B,strA,strB = get_rate(idlist, pass_dict)
        str = list(pass_dict.values())[0][1] + "/用例编号:"
        A_dict['source'] = str + strA
        A_dict['val'] = A
        B_dict['source'] = str + strB
        B_dict['val'] = B
        res_dict = {
            "val": res,
            "sub": [A_dict, B_dict]
...
def pcl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
...
def ccl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
...
def ucl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
...
def rcl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
...
def scl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
...
def mcl1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
        "des": "证实实现的可维护性依从性相关项数",
        "val": None
    }
    B_dict = {
        "id": "B",
...
def pcp1g_cd(idlist,pass_dict,use_case_document_list):
    A_dict = {
        "id": "A",
        "type": "测试文档",
        "source": "",
